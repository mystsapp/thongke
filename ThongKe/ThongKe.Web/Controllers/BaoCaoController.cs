...
namespace ThongKe.Web.Controllers
{
    public class BaoCaoController : BaseController
    {
        ...
        public ActionResult QuayTheoNgayBan()
        {
            return View();
        }

        [HttpPost]
        public void QuayTheoNgayBan(string tungay, string denngay)
        {
            ...
            // do du lieu tu table
            int dong = 5;
            //DataTable dt = new thongkeRepository().doanhthuQuayTheoNgayBan(tungay,denngay,"STS","OB");
            DataTable dt = _thongkeService.doanhthuQuayTheoNgayBan(tungay, denngay, "STS", "OB");// Session["daily"].ToString(), Session["khoi"].ToString());
        ...
        [HttpPost]
        public ViewResult QuayTheoNgayDi(string tungay, string denngay, string daily)
        {
            string fromTo = "";
            ExcelPackage ExcelApp = new ExcelPackage();
            ExcelWorksheet xlSheet = ExcelApp.Workbook.Worksheets.Add("Report");
        ...
        public ActionResult SaleTheoNgayBan()
        {
